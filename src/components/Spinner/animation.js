...
function setupAudio(sound) {
  ...
  const start = new Audio('https://cdn.casegods.gg/sounds/spinner_launch.wav')
  start.volume = volume
  start.playbackRate = 2
  const click = new Audio('https://cdn.casegods.gg/sounds/click4.mp3')
  click.playbackRate = 5
  click.volume = volume
  const stop = new Audio('https://cdn.casegods.gg/sounds/open.wav')
  stop.volume = volume
